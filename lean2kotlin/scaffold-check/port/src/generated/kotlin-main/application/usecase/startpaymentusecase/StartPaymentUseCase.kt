...
/**
 * Lean: モジュール `StartPaymentUseCase` の interface 面(署名は Lean の def の写し)。
...
interface StartPaymentUseCase {
	fun execute(c: StartPaymentCommand): DomainResult<DomainError, Unit>
	/**
	 ...
	 */
	fun validate(c: StartPaymentCommand): DomainResult<DomainError, Visit>
}
