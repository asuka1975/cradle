...
/**
 * Lean: モジュール `CloseNoteUseCase` の interface 面(署名は Lean の def の写し)。
 ...
 */
interface CloseNoteUseCase {
	fun execute(c: CloseNoteCommand): DomainResult<DomainError, Unit>
	/**
	 ...
	 */
	fun validate(c: CloseNoteCommand): DomainResult<DomainError, Note>
}
